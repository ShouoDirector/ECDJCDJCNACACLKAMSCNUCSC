<script>
        var roomTotal = <?php echo $totals['room']; ?>;
        var bedTotal = <?php echo $totals['bed']; ?>;
        var mealTotal = <?php echo $totals['meal']; ?>;
        var tipsTotal = <?php echo $totals['tips']; ?>;
                ...
                e.prototype.initCharts = function () {
                    ...
                    var e = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"],
                        ...
                        r = {
                            ...
                            series: [roomTotal, bedTotal, mealTotal, tipsTotal],
                            labels: ["Room Rent", "Bed Rent", "Meals", "Tips"],
