                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Non Conform Status</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Non Conform Status</h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-5">
                                            <a href="javascript:void(0);" class="btn btn-primary mb-2">Total NC
                                                Customers : <?php echo $c ?></a>
                                        </div>
                                        <div class="col-sm-7">
                                            <div class="text-sm-end">
                                                ...
                                                <form action="import_nc.php" method="post" enctype="multipart/form-data"
                                                    class="form-inline">
                                                    ...
                                                    <button type="submit" name="import"
                                                        class="btn btn-light mb-2">Import CSV</button>
                                                </form>
                                                <form action="export_nc.php" method="post" class="form-inline">
                                                    <button type="submit" name="export" class="btn btn-light mb-2"
                                                        style="display: inline-block;">Export CSV</button>
                                                </form>
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    while ($trow = mysqli_fetch_array($tre)) {	
                                                        $co = $trow['stat']; 
                                                        if ($co == "Not Conform") {
                                                            $cinFormatted = date("F j, Y", strtotime($trow['cin']));
                                                            $coutFormatted = date("F j, Y", strtotime($trow['cout']));
                                                            ...
                                                            echo "<tr>
                                                                ...
                                                                <td class='table-user'>
                                                                    <a href='javascript:void(0);' class='text-body fw-semibold'>".$trow['FName']." ".$trow['LName']."</a>
                                                                </td>
                                                                <td>
                                                                    ".$trow['Email']."
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <span class='badge badge-primary-lighten'>".$trow['stat']."</span>
                                                                </td>
                                                                <td class='text-center'>
                                                                    <a href='roombook.php?rid=" . $trow["id"] . "' class='action-icon'>
