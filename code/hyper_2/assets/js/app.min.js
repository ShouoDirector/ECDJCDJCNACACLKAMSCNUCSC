! function (e, t) {
    ...
    var p = function (n) {
        var e, d, b, o, r, p, f, g, w, l, u, E, T, s, C, m, a, c, v, x = "sizzle" + 1 * new Date,
            y = n.document,
            S = 0,
            i = 0,
            h = le(),
        ...
        function ae(t, e, n, i) {
            ...
            if (!i && ((e ? e.ownerDocument || e : y) !== T && E(e), e = e || T, C)) {
                if (11 !== h && (l = Z.exec(t)))
                    if (r = l[1]) {
                        if (9 === h) {
                        ...
                        if ((r = l[3]) && d.getElementsByClassName && e.getElementsByClassName) return j.apply(n, e.getElementsByClassName(r)), n
                    } if (d.qsa && !A[t + " "] && (!m || !m.test(t)) && (1 !== h || "object" !== e.nodeName.toLowerCase())) {
                    if (c = t, f = e, 1 === h && $.test(t)) {
                        for ((a = e.getAttribute("id")) ? a = a.replace(ie, re) : e.setAttribute("id", a = x), o = (u = p(t)).length; o--;) u[o] = "#" + a + " " + _e(u[o]);
        ...
        for (e in d = ae.support = {}, r = ae.isXML = function (e) {
                ...
                return i !== T && 9 === i.nodeType && i.documentElement && (s = (T = i).documentElement, C = !r(T), y !== T && (n = T.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", oe, !1) : n.attachEvent && n.attachEvent("onunload", oe)), d.attributes = ce(function (e) {
                ...
                if ((e.ownerDocument || e) !== T && E(e), d.matchesSelector && C && !A[t + " "] && (!a || !a.test(t)) && (!m || !m.test(t))) try {
                    var n = c.call(e, t);
                ...
                preFilter: {
                    ...
                    PSEUDO: function (e) {
                        var t, n = !e[6] && e[2];
                        return z.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && K.test(n) && (t = p(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function (e) {
        ...
        function Te(d, p, g, m, v, e) {
            return m && !m[x] && (m = Te(m)), v && !v[x] && (v = Te(v, e)), ue(function (e, t, n, i) {
                var r, o, s, a = [],
                    l = [],
                    u = t.length,
                    c = e || function (e, t, n) {
                ...
                } else h = Ee(h === t ? h.splice(u, h.length) : h), v ? v(null, t, h, i) : j.apply(t, h)
            })
        }
                ...
                if (t = b.relative[e[a].type]) c = [be(we(c), t)];
                    ...
                    if ((t = b.filter[e[a].type].apply(null, e[a].matches))[x]) {
                        ...
                        return Te(1 < a && we(c), 1 < a && _e(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(B, "$1"), t, a < n && Ce(e.slice(a, n)), n < i && Ce(e = e.slice(n)), n < i && _e(e))
                    }
                    c.push(t)
                } return we(c)
        }
        return ye.prototype = b.filters = b.pseudos, b.setFilters = new ye, p = ae.tokenize = function (e, t) {
            ...
            for (s = e, a = [], l = b.preFilter; s;) {
                for (o in n && !(i = U.exec(s)) || (i && (s = s.slice(i[0].length) || s), a.push(r = [])), n = !1, (i = Q.exec(s)) && (n = i.shift(), r.push({
                        value: n,
                        type: i[0].replace(B, " ")
                    }), s = s.slice(n.length)), b.filter) !(i = z[o].exec(s)) || l[o] && !(i = l[o](i)) || (n = i.shift(), r.push({
                    value: n,
                    type: o,
                    matches: i
                }), s = s.slice(n.length));
            ...
            if (!s) {
                ...
                (s = D(e, (m = o, y = 0 < (v = r).length, _ = 0 < m.length, i = function (e, t, n, i, r) {
                    ...
                    if (l += u, y && u !== l) {
                        ...
                        j.apply(i, f), r && !e && 0 < f.length && 1 < l + v.length && ae.uniqueSort(i)
                    }
                    return r && (S = p, w = h), c
                }, y ? ue(i) : i))).selector = e
            }
            ...
            if (n = n || [], 1 === c.length) {
                ...
                for (r = z.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !b.relative[a = s.type]);)
                    if ((l = b.find[a]) && (i = l(s.matches[0].replace(te, ne), ee.test(o[0].type) && ve(t.parentNode) || t))) {
                        if (o.splice(r, 1), !(e = i.length && _e(o))) return j.apply(n, i), n;
                        break
                    }
            }
            return (u || f(e, c))(i, t, !C, n, !t || ee.test(e) && ve(t.parentNode) || t), n
        }, d.sortStable = x.split("").sort(N).join("") === x, d.detectDuplicates = !!u, E(), d.sortDetached = ce(function (e) {
    ...
    (x.fn.init = function (e, t, n) {
        var i, r;
        if (!e) return this;
        if (n = n || O, "string" != typeof e) return e.nodeType ? (this[0] = e, this.length = 1, this) : y(e) ? void 0 !== n.ready ? n.ready(e) : e(x) : x.makeArray(e, this);
        if (!(i = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : k.exec(e)) || !i[1] && t) return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);
        if (i[1]) {
            if (t = t instanceof x ? t[0] : t, x.merge(this, x.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : C, !0)), N.test(i[1]) && x.isPlainObject(t))
    ...
    x.fn.extend({
        ...
        x.fn[i] = function (e, t) {
            ...
            return "Until" !== i.slice(-5) && (t = e), t && "string" == typeof t && (n = x.filter(t, n)), 1 < this.length && (L[i] || x.uniqueSort(n), j.test(i) && n.reverse()), this.pushStack(n)
        }
    });
    var P = /[^\x20\t\r\n\f]+/g;
    ...
    function B() {
        C.removeEventListener("DOMContentLoaded", B), T.removeEventListener("load", B), x.ready()
    }
    ...
    }), x.ready.then = W.then, "complete" === C.readyState || "loading" !== C.readyState && !C.documentElement.doScroll ? T.setTimeout(x.ready) : (C.addEventListener("DOMContentLoaded", B), T.addEventListener("load", B));
    ...
    function ue(e, t, n, i) {
        var r, o, s = 20,
            ...
            c = e.nodeType && (x.cssNumber[t] || "px" !== u && +l) && ne.exec(x.css(e, t));
        if (c && c[3] !== u) {
    ...
    function we(e, t, n, i, r) {
        for (var o, s, a, l, u, c, f = t.createDocumentFragment(), h = [], d = 0, p = e.length; d < p; d++)
            ...
            for (s = s || f.appendChild(t.createElement("div")), a = (de.exec(o) || ["", ""])[1].toLowerCase(), l = ge[a] || ge._default, s.innerHTML = l[1] + x.htmlPrefilter(o) + l[2], c = l[0]; c--;) s = s.lastChild;
    ...
    x.event = {
        ...
        add: function (t, e, n, i, r) {
            ...
            if (m)
                for (n.handler && (n = (o = n).handler, r = o.selector), r && x.find.matchesSelector(re, r), n.guid || (n.guid = x.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
                        return void 0 !== x && x.event.triggered !== e.type ? x.event.dispatch.apply(t, arguments) : void 0
                    }), u = (e = (e || "").match(P) || [""]).length; u--;) d = g = (a = Ce.exec(e[u]) || [])[1], p = (a[2] || "").split(".").sort(), d && (f = x.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, f = x.event.special[d] || {}, c = x.extend({
                    type: d,
                    origType: g,
                    data: i,
                    handler: n,
    ...
    function Re(n, i, r, o) {
        ...
        var e, t, s, a, l, u, c = 0,
            ...
            d = i[0],
            p = y(d);
        if (p || 1 < f && "string" == typeof d && !v.checkClone && ke.test(d)) return n.each(function (e) {
            var t = n.eq(e);
            p && (i[0] = d.call(this, e, t.html())), Re(t, i, r, o)
        });
        if (f && (t = (e = we(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            for (a = (s = x.map(me(e, "script"), He)).length; c < f; c++) l = e, c !== h && (l = x.clone(l, !0, !0), a && x.merge(s, me(l, "script"))), r.call(n[c], l, c);
            if (a)
                for (u = s[s.length - 1].ownerDocument, x.map(s, Pe), c = 0; c < a; c++) l = s[c], pe.test(l.type || "") && !X.access(l, "globalEval") && x.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? x._evalUrl && !l.noModule && x._evalUrl(l.src, {
    ...
    function Me(e, t, n) {
        for (var i, r = t ? x.filter(t, e) : e, o = 0; null != (i = r[o]); o++) n || 1 !== i.nodeType || x.cleanData(me(i)), i.parentNode && (n && oe(i) && ve(me(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    x.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || x.isXMLDoc(e)))
                for (s = me(c), i = 0, r = (o = me(e)).length; i < r; i++) a = o[i], l = s[i], void 0, "input" === (u = l.nodeName.toLowerCase()) && he.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
            if (t)
                if (n)
        ...
        replaceWith: function () {
            ...
            return Re(this, arguments, function (e) {
                ...
                x.inArray(this, n) < 0 && (x.cleanData(me(this)), t && t.replaceChild(e, this))
            }, n)
        }
    }), x.each({
        appendTo: "append",
    ...
    function Ue(e, t, n) {
        ...
        return (n = n || We(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || oe(e) || (s = x.style(e, t)), !v.pixelBoxStyles() && Fe.test(s) && Be.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    function tt(e, t, n) {
        ...
        return (!v.boxSizingReliable() && r || "auto" === s || !parseFloat(s) && "inline" === x.css(e, "display", !1, i)) && e.getClientRects().length && (r = "border-box" === x.css(e, "boxSizing", !1, i), (o = a in e) && (s = e[a])), (s = parseFloat(s) || 0) + et(e, t, n || (r ? "border" : "content"), o, i, s) + "px"
    }
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = V(t),
                    l = Xe.test(t),
                    u = e.style;
                if (l || (t = ze(a)), s = x.cssHooks[t] || x.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : u[t];
                "string" === (o = typeof n) && (r = ne.exec(n)) && r[1] && (n = ue(e, t, r), o = "number"), null != n && n == n && ("number" !== o || l || (n += r && r[3] || (x.cssNumber[a] ? "" : "px")), v.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? u.setProperty(t, n) : u[t] = n))
            }
        },
        css: function (e, t, n, i) {
            var r, o, s, a = V(t);
            return Xe.test(t) || (t = ze(a)), (s = x.cssHooks[t] || x.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = Ue(e, t, i)), "normal" === r && t in Je && (r = Je[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), x.each(["height", "width"], function (e, l) {
        x.cssHooks[l] = {
            get: function (e, t, n) {
                if (t) return !Ye.test(x.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? tt(e, l, n) : le(e, Ge, function () {
                    return tt(e, l, n)
                })
            },
            set: function (e, t, n) {
                var i, r = We(e),
                    ...
                    a = n ? et(e, l, n, s, r) : 0;
                return s && o && (a -= Math.ceil(e["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(r[l]) - et(e, l, "border", !1, r) - .5)), a && (i = ne.exec(t)) && "px" !== (i[3] || "px") && (e.style[l] = t, t = x.css(e, l)), Ze(0, t, a)
            }
        }
        ...
        css: function (e, t) {
            return U(this, function (e, t, n) {
                var i, r, o = {},
                    s = 0;
                if (Array.isArray(t)) {
                    for (i = We(e), r = t.length; s < r; s++) o[t[s]] = x.css(e, t[s], !1, i);
                    return o
                }
    ...
    function ut() {
        rt && (!1 === C.hidden && T.requestAnimationFrame ? T.requestAnimationFrame(ut) : T.setTimeout(ut, x.fx.interval), x.fx.tick())
    }
    ...
    function dt(o, e, t) {
        ...
        for (! function (e, t) {
            ...
            if (n = dt.prefilters[i].call(u, o, c, u.opts)) return y(n.stop) && (x._queueHooks(u.elem, u.opts.queue).stop = n.stop.bind(n)), n;
        return x.map(c, ht, u), y(u.opts.start) && u.opts.start.call(o, u), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always), x.fx.timer(x.extend(l, {
            elem: o,
            anim: u,
            queue: u.opts.queue
        })), u
    ...
    x.Animation = x.extend(dt, {
        ...
        prefilters: [function (e, t, n) {
            ...
            for (i in n.queue || (null == (s = x._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
                ...
                for (i in f && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (u = m && m.display) && (u = X.get(e, "display")), "none" === (c = x.css(e, "display")) && (u ? c = u : (fe([e], !0), u = e.style.display || u, c = x.css(e, "display"), fe([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === x.css(e, "float") && (l || (h.done(function () {
                        p.display = u
                    ...
                    for (i in g || fe([e]), X.remove(e, "fxshow"), d) x.style(e, i, d[i])
    ...
    }, ot = C.createElement("input"), st = C.createElement("select").appendChild(C.createElement("option")), ot.type = "checkbox", v.checkOn = "" !== ot.value, v.optSelected = st.selected, (ot = C.createElement("input")).value = "t", ot.type = "radio", v.radioValue = "t" === ot.value;
    var pt, gt = x.expr.attrHandle;
    x.fn.extend({
        attr: function (e, t) {
    ...
    x.fn.extend({
        val: function (n) {
            ...
            })) : t ? (i = x.valHooks[t.type] || x.valHooks[t.nodeName.toLowerCase()]) && "get" in i && void 0 !== (e = i.get(t, "value")) ? e : "string" == typeof (e = t.value) ? e.replace(wt, "") : null == e ? "" : e : void 0
        }
    }), x.extend({
        valHooks: {
            option: {
    ...
    x.extend(x.event, {
        trigger: function (e, t, n, i) {
            ...
            if (o = f = s = n = n || C, 3 !== n.nodeType && 8 !== n.nodeType && !Et.test(d + x.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(), p.sort()), l = d.indexOf(":") < 0 && "on" + d, (e = e[x.expando] ? e : new x.Event(d, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : x.makeArray(t, [e]), c = x.event.special[d] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!i && !c.noBubble && !_(n)) {
                    for (a = c.delegateType || d, Et.test(a + d) || (o = o.parentNode); o; o = o.parentNode) h.push(o), s = o;
                    s === (n.ownerDocument || C) && h.push(s.defaultView || s.parentWindow || T)
                }
                for (r = 0;
                    (o = h[r++]) && !e.isPropagationStopped();) f = o, e.type = 1 < r ? a : c.bindType || d, (u = (X.get(o, "events") || {})[e.type] && X.get(o, "handle")) && u.apply(o, t), (u = l && o[l]) && u.apply && z(o) && (e.result = u.apply(o, t), !1 === e.result && e.preventDefault());
                return e.type = d, i || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(h.pop(), t) || !z(n) || l && y(n[d]) && !_(n) && ((s = n[l]) && (n[l] = null), x.event.triggered = d, e.isPropagationStopped() && f.addEventListener(d, Tt), n[d](), e.isPropagationStopped() && f.removeEventListener(d, Tt), x.event.triggered = void 0, s && (n[l] = s)), e.result
            }
        },
    ...
    function Ot(n, e, i, r) {
        ...
        if (Array.isArray(e)) x.each(e, function (e, t) {
            i || Dt.test(n) ? r(n, t) : Ot(n + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, i, r)
        });
        else if (i || "object" !== w(e)) r(n, e);
        else
            for (t in e) Ot(n + "[" + t + "]", e[t], i, r)
    }
    x.param = function (e, t) {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !x(this).is(":disabled") && It.test(this.nodeName) && !Nt.test(e) && (this.checked || !he.test(e))
            }).map(function (e, t) {
                var n = x(this).val();
    ...
    Wt.href = Ct.href, x.extend({
        ...
        ajax: function (e, t) {
            ...
            var c, f, h, n, d, i, p, g, r, o, m = x.ajaxSetup({}, t),
                ...
                E = {
                    ...
                    getResponseHeader: function (e) {
                        ...
                        if (p) {
                            if (!n)
                                for (n = {}; t = Ht.exec(h);) n[t[1].toLowerCase() + " "] = (n[t[1].toLowerCase() + " "] || []).concat(t[2]);
                            t = n[e.toLowerCase() + " "]
                        }
            ...
            if (_.promise(E), m.url = ((e || m.url || Ct.href) + "").replace(qt, Ct.protocol + "//"), m.type = t.method || t.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(P) || [""], null == m.crossDomain) {
                i = C.createElement("a");
                try {
    ...
    v.cors = !!Kt && "withCredentials" in Kt, v.ajax = Kt = !!Kt, x.ajaxTransport(function (r) {
        var o, s;
    ...
    x.ajaxSetup({
        ...
        if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Yt, "$1" + i) : !1 !== e.jsonp && (e.url += (St.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function () {
            ...
            void 0 === r ? x(T).removeProp(i) : T[i] = r, e[i] && (e.jsonpCallback = t.jsonpCallback, zt.push(i)), o && y(r) && r(o[0]), o = r = void 0
        }), "script"
    }), v.createHTMLDocument = ((Vt = C.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Vt.childNodes.length), x.parseHTML = function (e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (v.createHTMLDocument ? ((i = (t = C.implementation.createHTMLDocument("")).createElement("base")).href = C.location.href, t.head.appendChild(i)) : t = C), o = !n && [], (r = N.exec(e)) ? [t.createElement(r[1])] : (r = we([e], t, o), o && o.length && x(o).remove(), x.merge([], r.childNodes)));
        var i, r, o
    }, x.fn.load = function (e, t, n) {
        var i, r, o, s = this,
            a = e.indexOf(" ");
        return -1 < a && (i = yt(e.slice(a)), e = e.slice(0, a)), y(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), 0 < s.length && x.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function (e, t, n) {
            var i, r, o, s, a, l, u = x.css(e, "position"),
                c = x(e),
                f = {};
            "static" === u && (e.style.position = "relative"), a = c.offset(), o = x.css(e, "top"), l = x.css(e, "left"), r = ("absolute" === u || "fixed" === u) && -1 < (o + l).indexOf("auto") ? (s = (i = c.position()).top, i.left) : (s = parseFloat(o) || 0, parseFloat(l) || 0), y(t) && (t = t.call(e, n, x.extend({}, a))), null != t.top && (f.top = t.top - a.top + s), null != t.left && (f.left = t.left - a.left + r), "using" in t ? t.using.call(e, f) : c.css(f)
        }
    }, x.fn.extend({
        offset: function (t) {
        ...
        x.cssHooks[n] = Qe(v.pixelPosition, function (e, t) {
            if (t) return t = Ue(e, n), Fe.test(t) ? x(e).position()[n] + "px" : t
        })
    }), x.each({
        Height: "height",
        Width: "width"
    ...
    }, x.isArray = Array.isArray, x.parseJSON = JSON.parse, x.nodeName = A, x.isFunction = y, x.isWindow = _, x.camelCase = V, x.type = w, x.now = Date.now, x.isNumeric = function (e) {
        var t = x.type(e);
    ...
    return x.noConflict = function (e) {
        return T.$ === x && (T.$ = Gt), e && T.jQuery === x && (T.jQuery = Xt), x
    }, e || (T.jQuery = T.$ = x), x
}),
function (e, t) {
    ...
    p(document).on(I.CLICK_DATA_API, x, function (e) {
        e.preventDefault();
        var t = e.target;
    ...
    var k = "carousel",
        ...
        ae = function () {
            ...
            return e.next = function () {
                ...
                p(this._element).off(L), p.removeData(this._element, j), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, e._getConfig = function (e) {
                return e = l({}, q, e), g.typeCheckConfig(k, e, R), e
    ...
    }), p.fn[k] = ae._jQueryInterface, p.fn[k].Constructor = ae, p.fn[k].noConflict = function () {
        return p.fn[k] = P, ae._jQueryInterface
    };
    var le = "collapse",
        ue = "bs.collapse",
        ce = "." + ue,
    ...
    for (var Ce = "undefined" != typeof window && "undefined" != typeof document, xe = ["Edge", "Trident", "Firefox"], Se = 0, De = 0; De < xe.length; De += 1)
        if (Ce && 0 <= navigator.userAgent.indexOf(xe[De])) {
            Se = 1;
            break
        } var Ae = Ce && window.Promise ? function (e) {
        var t = !1;
        return function () {
    ...
    function ke(e) {
        ...
        var t = Ie(e),
            ...
            i = t.overflowX,
            r = t.overflowY;
        return /(auto|scroll|overlay)/.test(n + r + i) ? e : ke(Oe(e))
    }
    var je = Ce && !(!window.MSInputMethodContext || !document.documentMode),
        Le = Ce && /MSIE 10/.test(navigator.userAgent);
    ...
    function Xe(e, t, n, i) {
        ...
        if ("viewport" === i) o = function (e) {
            ...
            var a = void 0;
            "scrollParent" === i ? "BODY" === (a = ke(Oe(t))).nodeName && (a = e.ownerDocument.documentElement) : a = "window" === i ? e.ownerDocument.documentElement : i;
            var l = ze(a, s, r);
    ...
    function at(e, t, n, i) {
        ...
        return function e(t, n, i, r) {
            ...
            s.addEventListener(n, i, {
                passive: !0
            }), o || e(ke(s.parentNode), n, i, r), r.push(s)
            ...
            modifiers: {
                ...
                arrow: {
                    ...
                    fn: function (e, t) {
                        ...
                        var r = e.placement.split("-")[0],
                            ...
                            d = l ? "bottom" : "right",
                            p = Ze(i)[u];
                        a[d] - p < s[f] && (e.offsets.popper[f] -= s[f] - (a[d] - p)), a[f] + p > s[d] && (e.offsets.popper[f] += a[f] + p - s[d]), e.offsets.popper = Ke(e.offsets.popper);
                        var g = a[f] + a[u] / 2 - p / 2,
                            m = Ie(e.instance.popper),
                            v = parseFloat(m["margin" + c], 10),
                            y = parseFloat(m["border" + c + "Width"], 10),
                            _ = g - e.offsets.popper[f] - v - y;
                        return _ = Math.max(Math.min(s[u] - p, _), 0), e.arrowElement = i, e.offsets.arrow = (Qe(n = {}, f, Math.round(_)), Qe(n, h, ""), n), e
                    },
                    element: "[x-arrow]"
                },
                flip: {
                ...
                inner: {
                    ...
                    fn: function (e) {
                        ...
                        return r[s ? "left" : "top"] = o[n] - (a ? r[s ? "width" : "height"] : 0), e.placement = et(t), e.offsets.popper = Ke(r), e
                    }
                },
                hide: {
                    order: 800,
                ...
                computeStyle: {
                    ...
                    fn: function (e, t) {
                        ...
                        var s, a, l, u, c, f, h, d, p, g, m, v, y, _, b = void 0 !== o ? o : t.gpuAcceleration,
                            ...
                            C = (s = e, a = window.devicePixelRatio < 2 || !ft, l = s.offsets, u = l.popper, c = l.reference, f = Math.round, h = Math.floor, d = function (e) {
                                return e
                            ...
                            A = void 0,
                            N = void 0;
                        if (N = "bottom" === x ? "HTML" === w.nodeName ? -w.clientHeight + C.bottom : -E.height + C.bottom : C.top, A = "right" === S ? "HTML" === w.nodeName ? -w.clientWidth + C.right : -E.width + C.right : C.left, b && D) T[D] = "translate3d(" + A + "px, " + N + "px, 0)", T[x] = 0, T[S] = 0, T.willChange = "transform";
                        else {
                            var I = "bottom" === x ? -1 : 1,
                                O = "right" === S ? -1 : 1;
                            T[x] = N * I, T[S] = A * O, T.willChange = x + ", " + S
                        }
                        var k = {
                            "x-placement": e.placement
                        };
                        return e.attributes = $e({}, k, e.attributes), e.styles = $e({}, T, e.styles), e.arrowStyles = $e({}, e.offsets.arrow, e.arrowStyles), e
                    },
                    gpuAcceleration: !0,
                    x: "bottom",
                    y: "right"
    ...
    var Et = "dropdown",
        ...
        At = {
            ...
            SHOWN: "shown" + Ct,
            CLICK: "click" + Ct,
            CLICK_DATA_API: "click" + Ct + xt,
            KEYDOWN_DATA_API: "keydown" + Ct + xt,
            KEYUP_DATA_API: "keyup" + Ct + xt
        },
        Nt = "disabled",
        It = "show",
        Ot = "dropup",
        ...
        Yt = function () {
            ...
            return e.toggle = function () {
                ...
                p.removeData(this._element, Tt), p(this._element).off(Ct), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
            }, e.update = function () {
                ...
                var e = p(this._element.parentNode),
                    t = Ut;
                return e.hasClass(Ot) ? (t = Wt, p(this._menu).hasClass(Lt) && (t = Bt)) : e.hasClass(kt) ? t = $t : e.hasClass(jt) ? t = Kt : p(this._menu).hasClass(Lt) && (t = Qt), t
            ...
            return e.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var u = function () {
                        ...
                        var e = t._hoverState;
                        t._hoverState = null, p(t.element).trigger(t.constructor.Event.SHOWN), e === jn && t._leave(null, t)
                    };
                ...
                var t = this,
                    ...
                    r = function () {
                        t._hoverState !== kn && n.parentNode && n.parentNode.removeChild(n), t._cleanTipClass(), t.element.removeAttribute("aria-describedby"), p(t.element).trigger(t.constructor.Event.HIDDEN), null !== t._popper && t._popper.destroy(), e && e()
                    };
                ...
                (t = t || p(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusin" === e.type ? Fn : Mn] = !0), p(t.getTipElement()).hasClass(Pn) || t._hoverState === kn ? t._hoverState = kn : (clearTimeout(t._timeout), t._hoverState = kn, t.config.delay && t.config.delay.show ? t._timeout = setTimeout(function () {
                    t._hoverState === kn && t.show()
                }, t.config.delay.show) : t.show())
            }, e._leave = function (e, t) {
                var n = this.constructor.DATA_KEY;
                (t = t || p(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusout" === e.type ? Fn : Mn] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = jn, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function () {
    ...
    p.fn[En] = Un._jQueryInterface, p.fn[En].Constructor = Un, p.fn[En].noConflict = function () {
        return p.fn[En] = xn, Un._jQueryInterface
    };
    var Qn = "popover",
        $n = "bs.popover",
        Kn = "." + $n,
    ...
    p.fn[Qn] = ii._jQueryInterface, p.fn[Qn].Constructor = ii, p.fn[Qn].noConflict = function () {
        return p.fn[Qn] = Vn, ii._jQueryInterface
    };
    var ri = "scrollspy",
        oi = "bs.scrollspy",
        si = "." + oi,
        ...
        Fi = function () {
            ...
            return e.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Ni) || p(this._element).hasClass(Ii))) {
                    var e, i, t = p(this._element).closest(Li)[0],
                ...
                p.removeData(this._element, Ci), this._element = null
            }, e._activate = function (e, t, n) {
                var i = this,
                    r = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? p(t).children(Hi) : p(t).find(Pi))[0],
                    o = n && r && p(r).hasClass(Oi),
                    s = function () {
                        return i._transitionComplete(e, r, n)
                    };
                if (r && o) {
                    var a = g.getTransitionDurationFromElement(r);
                    p(r).removeClass(ki).one(g.TRANSITION_END, s).emulateTransitionEnd(a)
                } else s()
                ...
                if (p(e).addClass(Ni), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), g.reflow(e), e.classList.contains(Oi) && e.classList.add(ki), e.parentNode && p(e.parentNode).hasClass(Ai)) {
                    var r = p(e).closest(ji)[0];
                    if (r) {
    ...
    var Wi = "toast",
        ...
        Zi = function () {
            ...
            return e.show = function () {
                var e = this;
                p(this._element).trigger($i.SHOW), this._config.animation && this._element.classList.add(Ki);
                var t = function () {
    ...
    p.fn[Wi] = Zi._jQueryInterface, p.fn[Wi].Constructor = Zi, p.fn[Wi].noConflict = function () {
            return p.fn[Wi] = Qi, Zi._jQueryInterface
        },
        function () {
            if (void 0 === p) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
            var e = p.fn.jquery.split(" ")[0].split(".");
            if (e[0] < 2 && e[1] < 9 || 1 === e[0] && 9 === e[1] && e[2] < 1 || 4 <= e[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
        }(), e.Util = g, e.Alert = m, e.Button = O, e.Carousel = ae, e.Collapse = Te, e.Dropdown = Yt, e.Modal = mn, e.Popover = ii, e.Scrollspy = Ti, e.Tab = Fi, e.Toast = Zi, e.Tooltip = Un, Object.defineProperty(e, "__esModule", {
            value: !0
        })
}),
function (t) {
            ...
            var u = function (e, t) {
                ...
                f = function (e) {
                    for (var t = 0; t < e.length; t++) {
                        h(e[t]).parent().removeClass(l.activeClass)
                    }
                };
            return this.each(function () {
                for (var o = this, e = h(l.container), s = h(o).find("a"), t = 0; t < s.length; t++) {
                    var n = s[t];
                    h(n).on("click", function (e) {
                        var t = h(this).attr("href"),
                            n = h(t);
                        if (0 < n.length) {
                            var i = u(n.offset().top, l.offset);
                            l.animate ? h("html, body").animate({
                                scrollTop: i
                            }, 1e3) : r.scrollTo(0, i), e.preventDefault()
                        }
                    })
                }
                var a = function (e) {
                    for (var t = [], n = 0; n < e.length; n++) {
                        var i = e[n],
                            ...
                            o = h(r);
                        if (0 < o.length) {
                            var s = Math.floor(o.offset().top),
                                a = s + Math.floor(o.outerHeight());
                            t.push({
                                element: o,
                                hash: r,
                                top: s,
                ...
                e.bind("scroll." + l.namespace, function () {
                    for (var e, t = {
                            top: u(h(this).scrollTop(), Math.abs(l.offset)),
                        ...
                        if (t.top >= i.top && t.top < i.bottom) {
                            var r = i.hash;
                            if (e = c(s, r)) {
                                l.onChange && l.onChange(i.element, h(o), t), f(s), e.parent().addClass(l.activeClass);
                                break
                            }
                        }
                    }!e && l.onExit && l.onExit(h(o), t)
                })
            })
        }
    })
...
function (t) {
    ...
    e.prototype.initComponents = function () {
        ...
        this.initComponents(), t(window).on("load", function () {}), t(window).on("scroll", function () {
            t(".navbar-toggle").on("click", function (e) {
                t(this).toggleClass("open"), t("#navigation").slideToggle(400)
            }), t(".navigation-menu>li").slice(-1).addClass("last-elements"), t(".menu-arrow,.submenu-arrow").on("click", function (e) {
